    ...
    <section id="about" className="py-24 bg-navy-800">
      <div className="container mx-auto px-6">
        <div className="flex flex-col items-center mb-16">
          ...
          <p className="text-slate-300 text-lg max-w-2xl text-center mt-4">
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-4">
              <p className="text-slate-300">
                I'm a <span className="text-purple-400 font-medium">Full Stack Developer and Machine Learning Engineer</span> with 
          ...
          <div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              <div className="bg-navy-700 p-6 rounded-lg card-hover">
                ...
                <p className="text-slate-300">+251918375305</p>
              </div>
              ...
              <div className="bg-navy-700 p-6 rounded-lg card-hover">
                ...
                <p className="text-slate-300">shimelsalem@gmail.com</p>
              </div>
              ...
              <div className="bg-navy-700 p-6 rounded-lg card-hover">
                ...
                <p className="text-slate-300">M.Sc. in Computer Science</p>
              </div>
              ...
              <div className="bg-navy-700 p-6 rounded-lg card-hover">
                ...
                <p className="text-slate-300">Addis Ababa, Ethiopia</p>
              </div>
            </div>
          </div>
        </div>
