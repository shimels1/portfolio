    ...
    <section id="contact" className="py-24">
      <div className="container mx-auto px-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
            ...
            <div className="bg-navy-800 p-8 rounded-xl mb-8">
              ...
              <div className="space-y-4">
                {/* <div className="flex items-center">
                  <div className="p-3 rounded-full bg-purple-700/20 mr-4">
                    <Phone className="text-purple-600" size={20} />
                  </div>
                  <div>
                    <p className="text-sm text-muted-foreground">Phone</p>
                    <p className="text-white">+251918375305</p>
                  </div>
                </div> */}
                <div className="flex items-center">
                  <div className="p-3 rounded-full bg-purple-700/20 mr-4">
                  ...
                  <div>
                    ...
                    <p className="text-white">shimelsalem@gmail.com</p>
                  </div>
                </div>
                <div className="flex items-center">
                  <div className="p-3 rounded-full bg-purple-700/20 mr-4">
          ...
          <form  action="https://formspree.io/f/xyyqzzjg" method="post" className="bg-navy-800 p-8 rounded-xl">
