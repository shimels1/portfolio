  ...
  const projects: Project[] = [
    {
      ...
      githubLink: "https://github.com/shimels1/continuous-sign-language-recognition",
    },  {
      ...
      githubLink: "https://github.com/shimels1/Entertainment-website",
    },
    {
      ...
      githubLink: "https://github.com/shimels1/online-food-ordering-system",
    },
  
    {
      ...
      githubLink: "https://github.com/shimels1/Pavement-Management-System-PMS-",
    },
    // {
    //   title: "Bible App",
              ...
              <div className="p-6">
                ...
                <div className="flex flex-wrap gap-2 mb-6">
                  {project.tags.map((tag) => (
                    <span
                      key={tag}
                      className="bg-navy-800 text-white text-xs px-3 py-1 rounded-full"
                    >
                      {tag}
                    </span>
                  ))}
